...
def custom_score(game, player):
    ...
    score = my_moves*weight1 - opponent_moves*weight2
...
def custom_score_3(game, player):
    ...
    opponent = game.get_opponent(player)
    opponent_moves = len(game.get_legal_moves(opponent))
    score = len(game.get_blank_spaces())+my_moves - 1.5*opponent_moves
    return float(score)
...
class MinimaxPlayer(IsolationPlayer):
    ...
    def min_value(self, game, depth):
        ...
        if self.terminal_test(game, depth):
            ...
            for move in game.get_legal_moves():
                ...
                score = min(score, self.max_value(next_step, depth-1))
    ...
    def max_value(self, game, depth):
        ...
        if self.terminal_test(game, depth):
            ...
            for move in game.get_legal_moves():
                next_step = game.forecast_move(move)
                score = max(score, self.min_value(next_step, depth-1))
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def max_value(self, game, depth, alpha, beta):
        ...
        if self.terminal_test(game, depth):
            ...
            for move in game.get_legal_moves():
                next_step = game.forecast_move(move)
                score = max(score, self.min_value(next_step, depth-1, alpha, beta))
                if score >= beta:
                    break
    ...
    def min_value(self, game, depth, alpha, beta):
        ...
        if self.terminal_test(game, depth):
            ...
            for move in game.get_legal_moves():
                next_step = game.forecast_move(move)
                score = min(score, self.max_value(next_step, depth-1, alpha, beta))
                if score <= alpha:
                    break
                beta = min(beta, score)
        return score
